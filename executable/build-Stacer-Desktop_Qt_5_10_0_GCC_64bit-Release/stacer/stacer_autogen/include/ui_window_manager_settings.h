...
public:
    ...
    {
        label->setText(QApplication::translate("WindowManagerSettings", "General", nullptr));
        grpAdditionalTitlebar->setTitle(QApplication::translate("WindowManagerSettings", "Titlebar Actions", nullptr));
        lblHomeIcon_9->setText(QApplication::translate("WindowManagerSettings", "Right click", nullptr));
        lblHomeIcon_7->setText(QApplication::translate("WindowManagerSettings", "Double click", nullptr));
        lblHomeIcon_8->setText(QApplication::translate("WindowManagerSettings", "Middle click", nullptr));
        label_3->setText(QApplication::translate("WindowManagerSettings", "Additional", nullptr));
        grpWorkspace->setTitle(QApplication::translate("WindowManagerSettings", "Workspace Settings", nullptr));
        checkWorkspaceSwitcher->setText(QString());
        lblMountedIcon_3->setText(QApplication::translate("WindowManagerSettings", "Vertical workspaces", nullptr));
        lblMountedIcon_2->setText(QApplication::translate("WindowManagerSettings", "Workspace switcher", nullptr));
        label_2->setText(QApplication::translate("WindowManagerSettings", "Horizontal workspaces", nullptr));
        grpAdditionalFocus->setTitle(QApplication::translate("WindowManagerSettings", "Focus Behaviour", nullptr));
        lblHomeIcon_4->setText(QApplication::translate("WindowManagerSettings", "Focus mode", nullptr));
        checkRaiseOnClick->setText(QString());
        lblHomeIcon_3->setText(QApplication::translate("WindowManagerSettings", "Raise on click", nullptr));
        grpHardware->setTitle(QApplication::translate("WindowManagerSettings", "Hardware Acceleration", nullptr));
        lblHomeIcon->setText(QApplication::translate("WindowManagerSettings", "Text quality", nullptr));
