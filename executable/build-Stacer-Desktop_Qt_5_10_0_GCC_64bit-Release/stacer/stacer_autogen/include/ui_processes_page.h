...
public:
    ...
    QPushButton *btnSetCPUPriority;
    QPushButton *btnLimitProcess;
    QPushButton *btnRemoveLimit;
    ...
    void setupUi(QWidget *ProcessesPage)
    {
        ...
        btnSetCPUPriority = new QPushButton(bottomWidget);
        btnSetCPUPriority->setObjectName(QStringLiteral("btnSetCPUPriority"));
        btnSetCPUPriority->setCursor(QCursor(Qt::PointingHandCursor));
        btnSetCPUPriority->setFocusPolicy(Qt::NoFocus);

        bottomLayout->addWidget(btnSetCPUPriority);

        btnLimitProcess = new QPushButton(bottomWidget);
        btnLimitProcess->setObjectName(QStringLiteral("btnLimitProcess"));
        btnLimitProcess->setCursor(QCursor(Qt::PointingHandCursor));
        btnLimitProcess->setFocusPolicy(Qt::NoFocus);
#ifndef QT_NO_ACCESSIBILITY
        btnLimitProcess->setAccessibleName(QStringLiteral("primary"));
#endif // QT_NO_ACCESSIBILITY

        bottomLayout->addWidget(btnLimitProcess);

        btnRemoveLimit = new QPushButton(bottomWidget);
        btnRemoveLimit->setObjectName(QStringLiteral("btnRemoveLimit"));
        btnRemoveLimit->setCursor(QCursor(Qt::PointingHandCursor));
        btnRemoveLimit->setFocusPolicy(Qt::NoFocus);
#ifndef QT_NO_ACCESSIBILITY
        btnRemoveLimit->setAccessibleName(QStringLiteral("primary"));
#endif // QT_NO_ACCESSIBILITY

        bottomLayout->addWidget(btnRemoveLimit);
...
#ifndef QT_NO_ACCESSIBILITY
        btnSetCPUPriority->setAccessibleName(QApplication::translate("ProcessesPage", "primary", nullptr));
#endif // QT_NO_ACCESSIBILITY
        btnSetCPUPriority->setText(QApplication::translate("ProcessesPage", "CPU Priority", nullptr));
        btnLimitProcess->setText(QApplication::translate("ProcessesPage", "Limit Process", nullptr));
        btnRemoveLimit->setText(QApplication::translate("ProcessesPage", "Remove Limit", nullptr));
