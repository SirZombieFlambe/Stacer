...
public:
    ...
    {
        grpScreenApps->setTitle(QApplication::translate("AppearanceSettings", "Screen Applications", nullptr));
        lblMountedIcon_5->setText(QApplication::translate("AppearanceSettings", "Screen Reader", nullptr));
        checkScreenReader->setText(QString());
        lblMountedIcon_4->setText(QApplication::translate("AppearanceSettings", "Screen Keyboard", nullptr));
        checkScreenKeyboard->setText(QString());
        grpBackground->setTitle(QApplication::translate("AppearanceSettings", "Background Image Mode", nullptr));
        lblMountedIcon_2->setText(QApplication::translate("AppearanceSettings", "Desktop Mode", nullptr));
        lblMountedIcon_3->setText(QApplication::translate("AppearanceSettings", "Login Mode", nullptr));
        grpIcons->setTitle(QApplication::translate("AppearanceSettings", "Icons", nullptr));
        lblHomeIcon->setText(QApplication::translate("AppearanceSettings", "Home Icon", nullptr));
        checkNetworkIcon->setText(QString());
        lblTrashIcon->setText(QApplication::translate("AppearanceSettings", "Trash Icon", nullptr));
        lblMountedIcon->setText(QApplication::translate("AppearanceSettings", "Mounted Volumes Icon", nullptr));
        checkHomeIcon->setText(QString());
        label->setText(QApplication::translate("AppearanceSettings", "Show Desktop Icons", nullptr));
        checkShowDesktopIcons->setText(QString());
        lblNetworkIcon->setText(QApplication::translate("AppearanceSettings", "Network Icon", nullptr));
