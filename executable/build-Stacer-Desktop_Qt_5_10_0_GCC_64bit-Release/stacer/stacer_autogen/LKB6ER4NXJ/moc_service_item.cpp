...
#include "../../../../Stacer/stacer/Pages/Services/service_item.h"
...
void ServiceItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ServiceItem *_t = static_cast<ServiceItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ServiceItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ServiceItem.data,
      qt_meta_data_ServiceItem,  qt_static_metacall, nullptr, nullptr}
};
