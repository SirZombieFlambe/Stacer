...
#include "../../../../Stacer/stacer/Pages/AptSourceManager/apt_source_manager_page.h"
...
void APTSourceManagerPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        APTSourceManagerPage *_t = static_cast<APTSourceManagerPage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject APTSourceManagerPage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_APTSourceManagerPage.data,
      qt_meta_data_APTSourceManagerPage,  qt_static_metacall, nullptr, nullptr}
};
